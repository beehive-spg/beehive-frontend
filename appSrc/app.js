...
import counterReducer from 'appSrc/reducers/counter'
...
if (SERVER) {
  ...
  */
	...
	const cert = require('appSrc/cert/self_signed')
	...
	config.setGraphQLSchema(require('appSrc/graphql/schema').default)
